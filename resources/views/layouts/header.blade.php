...
<head>
  ...
  <link rel="shortcut icon" href="{{asset('back')}}/dist/img/mylogo.png}}" type="image/x-icon">
  @yield('css')
  @toastr_css
</head>
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{asset('back')}}/dist/img/mylogo.png" alt="AdminLTELogo" height="100" width="100">
  </div>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{route('dashboard')}}" class="nav-link">Anasayfa</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" title="Oturum kapat"  href="{{route('logout')}}" role="button">
